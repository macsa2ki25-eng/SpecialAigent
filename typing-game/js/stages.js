...
(function (global) {
  const STAGES = [
    ...
    { id:11, name:'はんだくおん', desc:'ぱ・ぴ・ぷ・ぺ・ぽ を うとう。「ぱ」は P+A、「ぽ」は P+O。',
      type:'kana',  words:()=>Words.HANDAKUON,     questionCount:12, clearAccuracy:0.75, badge:'🍡', goal:'半濁音' },
    { id:12, name:'ようおん', desc:'きゃ・しゃ・ちゃ などの「ねじれ」おん。きゃ＝K+Y+A。',
      type:'kana',  words:()=>Words.YOUON,         questionCount:12, clearAccuracy:0.7,  badge:'🔥', goal:'拗音' },
    { id:13, name:'いろいろなことば', desc:'ならった ぜんぶの かなで ことばを うとう！',
      type:'word',  words:()=>Words.STAGE_WORDS,    questionCount:12, clearAccuracy:0.7,  badge:'📖', goal:'単語' },
    { id:14, name:'ポケモンずかん', desc:'ポケモンの なまえを タイピング！',
      type:'pokemon', words:()=>Words.STAGE_POKEMON, questionCount:10, clearAccuracy:0.7, badge:'⚡', goal:'ポケモン' },
    { id:15, name:'ポケモンのわざ', desc:'ながい わざの なまえに ちょうせん！',
